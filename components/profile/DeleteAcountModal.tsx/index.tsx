        ...
        >
          ...
          <View className="gap-2">
            <Text className="px-1 font-inter text-sm tracking-wider text-neutral-500">
              Type{" "}
              <Text className="font-inter-bold text-white uppercase">
                {CONFIRM_PHRASE}
              </Text>{" "}
              to confirm
            </Text>
            <TextInput
              ...
              autoCorrect={false}
              editable={!deleting}
              className={`h-14 rounded-2xl border px-4 font-inter-medium text-base text-white ${
                matches
          ...
          <Pressable
            ...
            className={`h-16 items-center justify-center rounded-2xl ${
              canConfirm ? "bg-red-500" : "bg-red-500/20"
            }`}
            style={({ pressed }) =>
            ...
            {deleting ? (
              ...
              <Text
                className={`font-inter-bold text-base ${
                  canConfirm ? "text-white" : "text-red-200/60"
                }`}
              >
                Delete my account
              </Text>
